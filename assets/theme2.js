...
var resize = function() {
	...
	var descriptionHeight = $('section#description').outerHeight( true );
	var windowHeight = $(window).height();
	var windowWidth = $(window).width();
	var availableHeight = windowHeight - headerHeight - footerHeight - descriptionHeight;
	...
	$('.photo').css('height', photoHeight - 60);
}
